...
function write_numFmts(NF /*:{[n:number|string]:string}*/ /*::, opts*/) {
  var o = ['<numFmts>']
  ;[[5, 8], [23, 26], [41, 44], [/*63*/ 50, /*66],[164,*/ 392]].forEach(
    function(r) {
  ...
  var StyleBuilder = function(options) {
    if (typeof module !== 'undefined' && typeof require !== 'undefined') {
      ...
      createElement = function(str) {
        return cheerio(cheerio(str, null, null, { xmlMode: true }))
      }
    ...
    return {
      ...
      _addFont: function(attributes) {
        ...
        $font
          .append(createElement('<sz/>').attr('val', attributes.sz))
        ...
        if (attributes.color) {
          if (attributes.color.theme) {
            $font.append(
              createElement('<color/>').attr('theme', attributes.color.theme)
            )
          } else if (attributes.color.rgb) {
            $font.append(
              createElement('<color/>').attr('rgb', attributes.color.rgb)
            )
          }
        }
      ...
      _addFill: function(attributes) {
        ...
        if (attributes.fgColor) {
          ...
          if (attributes.fgColor.rgb) {
            ...
            var $fgColor = createElement('<fgColor/>', null, null, {
              xmlMode: true
        ...
        if (attributes.bgColor) {
          var $bgColor = createElement('<bgColor/>', null, null, {
            xmlMode: true
          }).attr(attributes.bgColor)
          $patternFill.append($bgColor)
        }

        var $fill = createElement('<fill></fill>').append($patternFill)
      ...
      toXml: function() {
        ...
        if (this.$styles.xml) {
          return this.$styles.xml()
        } else {
          return baseXmlprefix + this.$styles.html()
        }
      }
    }.initialize(options || {})
  }
